...
//        List<Student> studentList = database.myDao().readData();
        ...
        myViewModel.readData().observe(this, new Observer<List<Student>>() {
            @Override
            public void onChanged(List<Student> students) {
                if (students.size() == 0) {
                    ...
                    rv.setAdapter(new MyAdapter(MainActivity.this, students));
                }
        ...
        rv.setAdapter(new MyAdapter(this, studentList));*/
